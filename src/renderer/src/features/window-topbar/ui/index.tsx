...
import { HorizontalLine } from '@shared/components/ui'
...
export const WindowHeader = () => {
  ...
  return (
    <header className="relative z-10 flex h-[2rem] w-full justify-between bg-background text-white area-drag">
      {/* Absolute */}
      <HorizontalLine
        offsetLeft={0}
        offsetRight={100}
        className={cn('bottom-0 right-0 z-50 w-screen duration-0')}
      />
      ...
      <div className="m-0 flex items-center justify-center">
        <button
          className="relative z-20 m-0 flex h-[2rem] w-[2.5rem] flex-col items-center justify-center rounded-none border-l border-dashed border-white/50 bg-background text-primary outline-none transition-colors duration-200 area-no-drag hover:bg-foreground hover:text-primary-foreground [&_svg]:size-min [&_svg]:shrink-0"
          style={{
            maskImage: 'linear-gradient(180deg, transparent, #000 20%, #000 100%, transparent)'
          }}
          aria-label="Свернуть"
          tabIndex={-1}
        ...
        <button
          className="relative z-20 m-0 flex h-[2rem] w-[2.5rem] flex-col items-center justify-center rounded-none border-l border-dashed border-white/50 bg-background text-primary transition-colors duration-200 area-no-drag hover:bg-foreground hover:text-primary-foreground [&_svg]:size-min [&_svg]:shrink-0"
          style={{
            maskImage: 'linear-gradient(180deg, transparent, #000 20%, #000 100%, transparent)'
          }}
        ...
        <button
          className="relative z-20 m-0 flex h-[2rem] w-[2.5rem] flex-col items-center justify-center rounded-none border-l border-dashed border-white/50 bg-background text-primary outline-none transition-all duration-200 area-no-drag hover:bg-destructive hover:text-primary-foreground [&_svg]:size-min [&_svg]:shrink-0"
          style={{
            maskImage: 'linear-gradient(180deg, transparent, #000 20%, #000 100%, transparent)'
          }}
          tabIndex={-1}

...
import {
  useCloseWindow,
  useMaximizeWindow,
  useMinimizeWindow // useNetworkConnection
} from '@entities/application'

import { VerticalLine } from '@shared/components/ui'
  ...
  return (
    <div className="m-0 flex items-center justify-center gap-4">
      ...
      <div className="m-0 flex">
        <button
          className="relative z-[80] m-0 flex h-[30px] w-[46px] flex-col items-center justify-center gap-0 rounded-none bg-background p-0 text-primary outline-none transition-colors duration-200 area-no-drag hover:bg-foreground hover:text-primary-foreground [&_svg]:size-min [&_svg]:shrink-0"
          aria-label="Свернуть"
          tabIndex={-1}
          onClick={() => handleMinimize()}
          onMouseEnter={() => $setCursor({ sizes: 30, offsetX: 22, offsetY: 46 })}
        ...
        <button
          className="relative z-[80] m-0 flex h-[30px] w-[46px] flex-col items-center justify-center gap-0 rounded-none bg-background p-0 text-primary outline-none transition-colors duration-200 area-no-drag hover:bg-secondary hover:text-primary-foreground [&_svg]:size-min [&_svg]:shrink-0"
          tabIndex={-1}
        ...
        <button
          className="relative z-[80] m-0 flex h-[30px] w-[46px] flex-col items-center justify-center gap-0 rounded-none bg-background p-0 text-primary outline-none transition-colors duration-200 area-no-drag hover:bg-destructive hover:text-primary-foreground [&_svg]:size-min [&_svg]:shrink-0"
          tabIndex={-1}
          aria-label="Закрыть"

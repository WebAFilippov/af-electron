  ...
  return (
    <header className="absolute right-0 top-0 flex h-8 w-full justify-end area-drag bg-background text-white">
      ...
      <div className="m-0 flex items-center justify-center">
        <button
          className="relative z-[80] m-0 flex h-[30px] w-[46px] flex-col items-center justify-center gap-0 rounded-none border-l border-dashed border-white/50 bg-background p-0 text-primary outline-none transition-colors duration-200 area-no-drag hover:bg-foreground hover:text-primary-foreground [&_svg]:size-min [&_svg]:shrink-0"
          style={{
        ...
        <button
          className="relative z-[80] m-0 flex h-[30px] w-[46px] flex-col items-center justify-center gap-0 rounded-none border-l border-dashed border-white/50 bg-background p-0 text-primary transition-colors duration-200 area-no-drag hover:bg-foreground hover:text-primary-foreground [&_svg]:size-min [&_svg]:shrink-0"
          style={{
            maskImage: 'linear-gradient(180deg, transparent, #000 20%, #000 100%, transparent)'
          }}
        ...
        <button
          className="relative z-[80] m-0 flex h-[30px] w-[46px] flex-col items-center justify-center gap-0 rounded-none border-l border-dashed border-white/50 bg-background p-0 text-primary outline-none transition-all duration-200 area-no-drag hover:bg-destructive hover:text-primary-foreground [&_svg]:size-min [&_svg]:shrink-0"
          style={{
            maskImage: 'linear-gradient(180deg, transparent, #000 20%, #000 100%, transparent)'
          }}
          tabIndex={-1}
